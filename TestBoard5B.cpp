...
//  TestBoard5B.cpp
//
//  A test program for the Board module.  It is the TestBoard5A
//    program expanded to also test copying and destroying
//    Boards.
//
...
const int COMPILE_AND_START_MARKS     =  6 - EXISTING_WORK_MARKS;
...
const int COMBINED_TEST_MARKS         = 30 + EXISTING_WORK_MARKS;
...
int main ()
{
	TestHelper::startup("TestBoard5B", COMPILE_AND_START_MARKS, TOTAL_MARKS_WITH_PART_C);
	...
	size_t board_bytes_array   = sizeof(char) * BOARD_SIZE_CORRECT * BOARD_SIZE_CORRECT;
	bool correct_board_bytes   = false;
	if(board_bytes == board_bytes_pointer)
	{
		cout << "* Correct for Part B" << endl;
		correct_board_bytes = true;
	}
	else if(board_bytes >= board_bytes_pointer &&
	        board_bytes <= board_bytes_pointer * 4)
	{
		cout << "* Extra variables in Board besides pointer" << endl;
		cout << "* Acceptable for Part B" << endl;
		correct_board_bytes = true;
	}
	else if(board_bytes == board_bytes_array)
		cout << "* Incorrect: Board array should be dynamically allocated" << endl;
	else
		cout << "* Incorrect: Board should contain a dynamically allocated array" << endl;
	cout << endl;
/*
...
*/
	...
	unsigned int highest1 = calculateMark(true, true, true, BOARD_VALUE_COUNT_WITH_MARKED, // constants and types
	                                      ...
	                                      false);        // finished
	unsigned int mark1 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
	                                   0.0, 0, 0, 0,  // basic board manipulation
	                                   0,             // load
	                                   0.0,           // basic print
	                                   0.0,           // print star points
	...
	if(correct_default_constructor == BOARD_CELL_COUNT)
		cout << "* Correct" << endl;
	else
	{
		int wrong_count = BOARD_CELL_COUNT - correct_default_constructor;
		if(wrong_count > 1)
	...
	double correct_default_constructor_fraction = (double)(correct_default_constructor) / BOARD_CELL_COUNT;
	...
	unsigned int highest2 = calculateMark(true, true, true, BOARD_VALUE_COUNT_WITH_MARKED, // constants and types
	                                      ...
	                                      0.0, 0.0,      // assignment operator (fancy)
	                                      false);        // finished
	unsigned int mark2 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
	...
	unsigned int highest3 = calculateMark(true, true, true, BOARD_VALUE_COUNT_WITH_MARKED, // constants and types
	                                      1.0, BOARD_VALUE_COUNT, 10, BOARD_VALUE_COUNT,  // basic board manipulation
	                                      ...
	                                      0.0, 0.0,      // assignment operator (fancy)
	                                      false);        // finished
	unsigned int mark3 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
	                                   correct_default_constructor_fraction, correct_count_with_value,
	                                   correct_set_at, correct_count_after_set,
	                                   correct_load,
	                                   0.0,           // basic print
	...
	unsigned int highest4 = calculateMark(true, true, true, BOARD_VALUE_COUNT_WITH_MARKED, // constants and types
	                                      1.0, BOARD_VALUE_COUNT, 10, BOARD_VALUE_COUNT,  // basic board manipulation
	                                      LOAD_BOARD_VALUE_COUNT,  // load
	                                      1.0,           // basic print
	                                      ...
	                                      0.0, 0.0,      // assignment operator (fancy)
	                                      false);        // finished
	unsigned int mark4 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
	                                   correct_default_constructor_fraction, correct_count_with_value,
	                                   correct_set_at, correct_count_after_set,
	                                   correct_load,
	...
	else
	{
...

		{
			...
			cout << "* Completed without crashing" << endl;
			correct_copy_to += testBoardCountWithValue(board_shapes2, SHAPES_STONE_COUNT, SHAPES_STONE_COUNT, true);
			cout << endl;

			cout << "Checking original \"shapes.txt\"" << endl;
			correct_copy_from += testBoardCountWithValue(board_shapes, SHAPES_STONE_COUNT, SHAPES_STONE_COUNT, true);
			cout << endl;

			cout << "Copying board \"simple.txt\"" << endl;
			Board board_simple2 = board_simple;
			cout << "* Completed without crashing" << endl;
			correct_copy_to += testBoardCountWithValue(board_simple2, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
			cout << endl;

			cout << "Checking original \"simple.txt\"" << endl;
			correct_copy_from += testBoardCountWithValue(board_simple, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
			cout << endl;
		...
		correct_copy_delete += testBoardCountWithValue(board_shapes, SHAPES_STONE_COUNT, SHAPES_STONE_COUNT, true);
		cout << endl;

		cout << "Checking original \"simple.txt\" board" << endl;
		correct_copy_delete += testBoardCountWithValue(board_simple, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
		cout << endl;
		...
		unsigned int highest5 = calculateMark(true, true, true, BOARD_VALUE_COUNT_WITH_MARKED, // constants and types
											  1.0, BOARD_VALUE_COUNT, 10, BOARD_VALUE_COUNT,  // basic board manipulation
											  LOAD_BOARD_VALUE_COUNT,  // load
											  1.0,           // basic print
											  1.0,           // print star points
		                                      ...
		                                      0.0, 0.0,      // assignment operator (fancy)
											  false);        // finished
		unsigned int mark5 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
										   correct_default_constructor_fraction, correct_count_with_value,
										   correct_set_at, correct_count_after_set,
										   correct_load,
										   correct_basic_print_fraction,
		...
		unsigned int highest6 = calculateMark(true, true, true, BOARD_VALUE_COUNT_WITH_MARKED, // constants and types
											  1.0, BOARD_VALUE_COUNT, 10, BOARD_VALUE_COUNT,  // basic board manipulation
											  LOAD_BOARD_VALUE_COUNT,  // load
											  1.0,           // basic print
											  1.0,           // print star points
		                                      ...
		                                      0.0, 0.0,      // assignment operator (fancy)
											  false);        // finished
		unsigned int mark6 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
										   correct_default_constructor_fraction, correct_count_with_value,
										   correct_set_at, correct_count_after_set,
										   correct_load,
										   correct_basic_print_fraction,
		...
		unsigned int highest7 = calculateMark(true, true, true, BOARD_VALUE_COUNT_WITH_MARKED, // constants and types
											  1.0, BOARD_VALUE_COUNT, 10, BOARD_VALUE_COUNT,  // basic board manipulation
											  LOAD_BOARD_VALUE_COUNT,  // load
											  1.0,           // basic print
											  1.0,           // print star points
		                                      ...
		                                      0.0, 0.0,      // assignment operator (fancy)
											  false);        // finished
		unsigned int mark7 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
										   correct_default_constructor_fraction, correct_count_with_value,
										   correct_set_at, correct_count_after_set,
										   correct_load,
										   correct_basic_print_fraction,
		...
		TestHelper::printMarkPartial(mark7, highest7, TOTAL_MARKS_WITH_PART_C);
...

		{
			...
			cout << "* Completed without crashing" << endl;
			correct_assign_to += testBoardCountWithValue(board_assign, SHAPES_STONE_COUNT, SHAPES_STONE_COUNT, true);
			cout << endl;

			cout << "Checking original \"shapes.txt\"" << endl;
			correct_assign_from += testBoardCountWithValue(board_shapes, SHAPES_STONE_COUNT, SHAPES_STONE_COUNT, true);
			cout << endl;

			cout << "Assigning board to \"simple.txt\"" << endl;
			board_assign = board_simple;
			cout << "* Completed without crashing" << endl;
			correct_assign_to += testBoardCountWithValue(board_assign, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
			cout << endl;
			...
			cout << "Checking original \"simple.txt\"" << endl;
			correct_assign_from += testBoardCountWithValue(board_simple, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
			cout << endl;
			...
			correct_self_assign += testBoardCountWithValue(board_assign, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
			cout << endl;
			...
			cout << "* Completed without crashing" << endl;
			correct_chain_assign += testBoardCountWithValue(board_assign, SHAPES_STONE_COUNT, SHAPES_STONE_COUNT, true);
			cout << endl;
			...
			cout << "* Completed without crashing" << endl;
			correct_chain_assign += testBoardCountWithValue(board_assign, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
			cout << endl;
		...
		cout << "Checking original \"shapes.txt\" board" << endl;
		correct_assign_delete += testBoardCountWithValue(board_shapes, SHAPES_STONE_COUNT, SHAPES_STONE_COUNT, true);
		cout << endl;

		cout << "Checking original \"simple.txt\" board" << endl;
		correct_assign_delete += testBoardCountWithValue(board_simple, SIMPLE_STONES_BLACK, SIMPLE_STONES_WHITE, true);
		cout << endl;
	}
	...
	unsigned int mark8 = calculateMark(correct_board_size, correct_board_bytes, correct_removed_bytes, correct_board_value,
	                                   correct_default_constructor_fraction, correct_count_with_value,
	                                   correct_set_at, correct_count_after_set,
	                                   correct_load,
	                                   correct_basic_print_fraction,
	...
	TestHelper::printMarkPartial(mark8, TOTAL_MARKS, TOTAL_MARKS_WITH_PART_C);
                   ...
                   bool is_finished)
{
	...
	// Part A
	//  -> tests from earlier assignments

	mark += (int)(2 * correct_default_constructor_fraction);
	...
	if(correct_load)
		mark += 1;
	if(correct_basic_print_fraction == 1.0)
		mark += 1;
	if(correct_star_point_fraction    == 1.0 &&
	...
	if(correct_replace_all_fraction  == 1.0 &&
	   correct_is_neighbour_fraction == 1.0)
	{
		mark += 1;
	}
	if(correct_fill_connected_fraction == 1.0)
		mark += 1;
	if(correct_calculate_score_fraction == 1.0 &&
	...
	mark += (int)(4.0 * correct_copy_to_fraction);
	mark += (int)(2.0 * correct_copy_from_fraction);
	mark += (int)(2.0 * correct_copy_delete_fraction);
	mark += (int)(4.0 * correct_assign_to_fraction);
	mark += (int)(2.0 * correct_assign_from_fraction);
	mark += (int)(2.0 * correct_assign_delete_fraction);
	mark += (int)(2.0 * correct_self_assign_fraction);
	mark += (int)(2.0 * correct_chain_assign_fraction);
