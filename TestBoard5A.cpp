...
//  TestBoard5A.cpp
//
//  A test program for the Board module.  It a modified form of
//    the TestBoard3D program.
//
...
const int COMPILE_AND_START_MARKS     =  3 - EXISTING_WORK_MARKS;
...
const int COMBINED_TEST_MARKS         = 10 + EXISTING_WORK_MARKS;
const int TOTAL_MARKS                 = COMPILE_AND_NOT_CRASH_MARKS + COMBINED_TEST_MARKS;
const int TOTAL_MARKS_WITH_PART_B     = TOTAL_MARKS + 30;
const int TOTAL_MARKS_WITH_PART_C     = TOTAL_MARKS_WITH_PART_B + 25;
...
int main ()
{
	TestHelper::startup("TestBoard5A", COMPILE_AND_START_MARKS, TOTAL_MARKS_WITH_PART_C);
	...
	else if(board_bytes > board_bytes_array * 4 / 3)  // extra space because padding happens
		cout << "* Incorrect: Board should contain less data (array too large?)" << endl;
	else
	{
		cout << "* Correct for Part A" << endl;
